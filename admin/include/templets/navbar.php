...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-indigo-600"
    ...
    <div class="navbar-header">
      ...
      <a href="dashboard.php"><div class="navbar-brand navbar-brand-center">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              <a class="dropdown-item" href="members.php?do=Edite&userid=<?php echo $_SESSION['id'] ?>" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profile</a>
              <a class="dropdown-item" href="../index.php" role="menuitem"><i class="icon wb-payment" aria-hidden="true"></i>Visit Shop</a>
      ...
      <ul class="site-menu" data-plugin="menu">
        ...
        <li class="site-menu-item has-sub">
          <a href="members.php?do=manage">
                    ...
                    <i class="site-menu-icon fas i_c fa-users-cog"></i>
                    <span class="site-menu-title">Members</span>
                </a>
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a href="members.php?do=Edite&userid=<?php echo $_SESSION['id'] ?>">
                <span class="site-menu-title">
                <i class="fas fa-user-edit"></i>profile edite</span>
              </a>
            </li>
            <li class="site-menu-item">
              <a href="members.php?do=Add&userid=''">
                   <span class="site-menu-title">
                  <i class="fas fa-user-plus"></i>User Add</span>
              </a>
            </li>
          </ul>
        </li>
        <li class="site-menu-item has-sub">
          <a href="categoris.php">
                    ...
                    <span class="site-menu-title">Categoris</span>
                </a>
          <ul class="site-menu-sub">
            
            <li class="site-menu-item">
              <a href="categoris.php?do=Add">
                <span class="site-menu-title"><i class="fas fa-folder-plus"></i>Add Categori</span>
              </a>
            </li>
            <li class="site-menu-item has-sub">
        ...
        <li class="site-menu-item has-sub">
          <a href="Items.php">
                    <i class="site-menu-icon fas i_c fas fa-sitemap"></i>
                    <span class="site-menu-title">Items</span>
                </a>
          <ul class="site-menu-sub">
              <li class="site-menu-item has-sub">
                  <a href="items.php?do=Add">
                      <span class="site-menu-title">Add Items</span>
                  </a>
              </li>
          </ul>
        </li>
        <li class="site-menu-item has-sub">
          <a href="comments.php">
                    <i class="site-menu-icon far fa-comments" aria-hidden="true"></i>
